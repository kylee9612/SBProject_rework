...
<%@ include file="/fix/sub_header.jsp"%>
	...
	<%
	ArrayList<ItemDTO> iList = idao.getItemLists(log);
	%>
<head>
<meta charset="UTF-8">
...
<div id="wrap">
	...
	<div class="contents">
 			...
 			%>
				<li>
					<ul class="item_wrap">
						...
						<li class="code"><%=item.getCode()%></li>
						<li class="viewCut"><%=item.getView_count()%></li>
						<li class="likeCut"><%=item.getLike_count()%></li>
						<li class="category"><%=item.getCategory()%></li>
						<li class="price"><%=item.getPrice()%>원</li>
						<li class="del"><a
							href="/green_project/ServicesServlet?command=deleteItem&id=<%=log%>&code=<%=item.getCode()%>"><img
		...
		<br> <input type="submit" value="내정보"
